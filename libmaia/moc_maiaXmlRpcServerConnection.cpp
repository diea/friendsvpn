...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MaiaXmlRpcServerConnection_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 96, 14)
    ...
    "const char**\0responseSlot\0readFromSocket\0"
};
...
const QMetaObject MaiaXmlRpcServerConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MaiaXmlRpcServerConnection.data,
      qt_meta_data_MaiaXmlRpcServerConnection,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MaiaXmlRpcServerConnection.stringdata))
