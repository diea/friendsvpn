...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MaiaObject_t, stringdata) + ofs \
...
const QMetaObject MaiaObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MaiaObject.data,
      qt_meta_data_MaiaObject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MaiaObject.stringdata))
