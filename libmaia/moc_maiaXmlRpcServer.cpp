...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MaiaXmlRpcServer_t, stringdata) + ofs \
...
const QMetaObject MaiaXmlRpcServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MaiaXmlRpcServer.data,
      qt_meta_data_MaiaXmlRpcServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MaiaXmlRpcServer.stringdata))
